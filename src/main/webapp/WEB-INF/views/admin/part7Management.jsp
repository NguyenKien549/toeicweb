				...
				<div class="col-12 row justify-content-end"
					...
					<div class="col-md-2 type">
						<select class="form-control" id="selectDataTable">
							...
							<option value="part7" selected="selected">Part 7</option>
...
<!-- 					</div> -->
		...
		<jsp:include page="../default/paginationAdmin.jsp"></jsp:include>
			...
			<div class="col-11 row justify-content-start"
				...
				<input id="add" type="button" class="part7" value="Add Question"
				...
				<input id="update" type="button" class="part7" value="Edit Question"
					style="padding: 0.8em 1em; background-color: #c9310c; color: white; border: none; border-radius: 0.5em; margin-right: 2em">
				<input id="delete" class="part7" type="button" value="Delete Question"
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer" style="justify-content: center">
					<button id="part7" style="background-color: #c9310c; color: white"
