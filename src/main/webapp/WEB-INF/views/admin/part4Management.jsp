				...
				<div class="col-12 row justify-content-end"
					...
					<div class="col-md-2 type">
						<select class="form-control" id="selectDataTable">
							...
							<option value="part4" selected="selected">Part 4</option>
...
<!-- 					</div> -->
							...
							<c:forEach items="${listQuestion}" var="question">
								<tr class="d-flex">
									...
									<audio class="playAudio" controls>
									 		<source src="${pageContext.request.contextPath }/${question.getAudioPart4().getAudio()}" type="audio/mpeg">
									 </audio></td>
								</tr>
							</c:forEach>
						</tbody>
		...
		<jsp:include page="../default/paginationAdmin.jsp"></jsp:include>
			...
			<div class="col-11 row justify-content-start"
				...
				<input id="add" type="button" class="part4" value="Add Question"
				...
				<input id="update" type="button" class="part4" value="Edit Question"
					style="padding: 0.8em 1em; background-color: #c9310c; color: white; border: none; border-radius: 0.5em; margin-right: 2em">
				<input id="delete" class="part4" type="button" value="Delete Question"
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer" style="justify-content: center">
					<button id="part4" style="background-color: #c9310c; color: white"
