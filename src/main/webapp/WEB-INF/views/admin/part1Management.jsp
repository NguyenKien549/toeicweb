...
<!-- 					</div> -->
						...
						<tbody class="bodyTable">
							<c:forEach items="${listQuestion}" var="question">
								<tr class="d-flex">
									...
									<td class="col-sm-1 col-md-1"><audio class="playAudio"
											controls id="${question.getAudioPart1().getId()}"> <source
											src="${pageContext.request.contextPath }/${question.getAudioPart1().getAudio()}"
											type="audio/mpeg"></audio></td>
									<td class="col-sm-1 col-md-1"><img
										src="${pageContext.request.contextPath }/${question.getImage()}"
	...
	<jsp:include page="../default/paginationAdmin.jsp"></jsp:include>
			...
			<div class="col-11 row justify-content-start"
				...
				<input id="add" type="button" class="part1" value="Add Question"
						...
						<div class="audioQuestions">
							<div class="questions question1">
								<div class="input-modal row">
									<span class="col-2" style="line-height: 35px">Image </span> <input
										type="file" class="col-8 form-control" id="image1">
								</div>
								<div class="input-modal row">
									<span class="col-2" style="line-height: 35px">Question</span> <input
										type="text" class="col-8 form-control" id="question1"
										class="form-control"> <img
										src='<c:url value="/resources/img/add_button_2-512.png"></c:url>'
										alt="abc" class="col-1 add add_Question part1"> <img
										src='<c:url value="/resources/img/subtract-512.png"></c:url>'
										class="col-1 sub sub_Question">
								</div>
								<div class="input-modal row">
								...
								<div class="input-modal row">
									<span class="col-2" style="line-height: 35px">B</span> <input
										class="col-8 form-control" type="text" id="B1">
								</div>
								<div class="input-modal row">
									<span class="col-2" style="line-height: 35px">C</span> <input
										class="col-8 form-control" type="text" id="C1">
								</div>
								<div class="input-modal row">
								...
								<div class="input-modal row">
									<span class="col-2" style="line-height: 35px">Right
										Answer:</span> <select class="col-8 form-control" id="RightAnswer1">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="question">
						...
						<div class="input-modal row">
							<span class="col-2" style="line-height: 35px">Image</span> <input
								type="file" class="col-7 form-control" id="editImage">
							<div id="viewEditImage" class="col-2"></div>
						</div>
						<div class="editAudio" style="display: none"></div>
						<div class="input-modal row">
							<span class="col-2" style="line-height: 35px">Question </span> <input
					...
					<div class="modal-footer" style="justify-content: center">
						<button id="part1" style="background-color: #c9310c; color: white"
