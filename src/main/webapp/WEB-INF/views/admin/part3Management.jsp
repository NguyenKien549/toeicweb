				...
				<div class="col-12 row justify-content-end"
					...
					<div class="col-md-2 type">
						<select class="form-control" id="selectDataTable">
							...
							<option value="part3" selected="selected">Part 3</option>
...
<!-- 					</div> -->
					...
					<table class="table table-bordered questionTable"
						...
						<thead class="thead-dark headerTable">
							<tr class="d-flex">
								...
								<th class="col-sm-5 col-md-5">Question</th>
						...
						<tbody class="bodyTable">
							<c:forEach items="${listQuestion}" var="question">
								<tr class="d-flex">
									...
									<td class="col-sm-5 col-md-5">${question.getQuestion() }</td>
									...
									<td class="col-sm-1 col-md-1"><audio class="playAudio"
											controls> <source
											src="${pageContext.request.contextPath }/${question.getAudioPart3().getAudio()}"
	...
	<jsp:include page="../default/paginationAdmin.jsp"></jsp:include>
			...
			<div class="col-11 row justify-content-start"
				...
				<input id="add" type="button" class="part3" value="Add Question"
							...
							<div class="questions question1">
								<div class="input-modal row">
									<span class="col-2" style="line-height: 35px">Question</span> <input
										...
										alt="abc" class="col-1 add add_Question"> <img
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer" style="justify-content: center">
					<button id="part3" style="background-color: #c9310c; color: white"
