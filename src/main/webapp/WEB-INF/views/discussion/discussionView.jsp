						...
						<c:forEach items="${discussion.getCommentList()}" var="comment">
							<div class="row comment">
								<c:choose>
									<c:when test="${name==null}">
										<div class="col-9 avt ">
											<img src="${pageContext.request.contextPath}/${comment.getUser().getAvatar()}"
												width="40px" height="40px"
												style="opacity: 0.8; border-radius: 20px;"><span style="margin-left: 5px;">${comment.getUser().getUsername()}</span>
										...
										<div class="col-1 menu" >
											<div class="dropdown">
												<img src="../../resources/img/option_icon.png" class="option-icon dropdown-toggle" data-toggle="dropdown">
												<ul class="dropdown-menu commentOption" style="min-width: 50px;width: 70px">
													<li id="report" class="reportButton" data-target="#login-box" data-toggle="modal">Report</li>
												</ul>
											</div>
										</div>
...
<!-- 										danh tinh nguoi dung -->
										...
										<div class="col-1 menu" >
											<div class="dropdown">
												<img class="option-icon dropdown-toggle" src="../../resources/img/option_icon.png" data-toggle="dropdown">
												<ul class="dropdown-menu commentOption" style="min-width: 50px;width: 70px">
													<li id="${comment.getId()}" class="reportOption" data-target="#reportComment-box" data-toggle="modal">Report</li>
													<c:choose>
														<c:when test="${user.getUsername() == comment.getUser().getUsername()}">
															<li id="${comment.getId()}" class="editOption" data-target="#editComment-box" data-toggle="modal">Edit</li>
										...
										<div class="col-12 commentContent">
											...
											<a href="#" class="reply" id="reply${count}">Reply</a> 
												<a href="#" class="report" id="report${count}">Report</a>
								...
								<div class="modal-body">
									<div class="form-group">
										...
										<textarea class="form-control" rows="4"
											id="editedContent" placeholder="input yoru comment" required="required"></textarea>
									</div>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<div class="form-group">
										...
										<textarea class="form-control" rows="4"
											id="reportedContent" placeholder="input your report" required="required"></textarea>
									</div>
				
									<button type="button" class="btn btn-primary reportCommentButton">Report</button>
								</div>
							</div>
						</div>
					</div><!-- het report-dialog -->
